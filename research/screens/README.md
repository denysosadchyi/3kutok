...
Публічні екрани конкурентів, зафіксовані 2026-09-02 у Chromium
1440×1100. Кожен валідний доказ підписано в
...
- `qonys.png` — Google Play із реальними product screenshots і 500+
  завантажень.
- `olx.png` — зафіксована сторінка 404; не використовується як доказ.
- `lun.png` — зафіксований Cloudflare challenge; не використовується як
  доказ.
